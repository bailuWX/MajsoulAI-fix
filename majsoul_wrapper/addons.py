...
class ClientWebSocket:
    ...
    def websocket_message(self, flow: mitmproxy.websocket.WebSocketFlow):
        ...
        # var3 = tamperUsetime(flow_msg)
        # result = liqi.parse(flow_msg)
        # print('A-=====================================A')
        # print("tamperUsetime:"+str(var3))
        # print("liqi.parse:"+str(result))
...
# service_arg = ['--verbose', '--proxy-server=127.0.0.1:8080', '--ignore-certificate-errors',
#                # '--ignore-ssl-errors'
#                ]
# browser = Edge(
#     options=options,
